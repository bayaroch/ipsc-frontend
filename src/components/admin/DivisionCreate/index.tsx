...
import { DivisionCreateParams } from '@services/division.services'
...
const DivisionCreate: React.FC<PickerProps> = (props) => {
  ...
  return (
    <Dialog fullScreen open={open} onClose={handleClose}>
      <form id="division-create-update" onSubmit={handleSubmit(onSubmit)}>
        <ButtonGroup
          fullWidth
          size="large"
          color="primary"
