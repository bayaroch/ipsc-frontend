...
export interface DivisionListProps {
  ...
  onEditDivision?: (data: DivisionItem) => void
  meta: Meta
...
const DivisionList: React.FC<DivisionListProps> = (props) => {
  const {
    getList,
    list,
    pagination,
          ...
          <TableContainer component={Paper}>
            <Table sx={{ minWidth: 500 }} aria-label="custom pagination table">
              <TableHead>
                <TableRow>
                  <TableCell>#</TableCell>
                  <TableCell align="right">Товч</TableCell>
                ...
                {list.map((row) => (
                  <TableRow key={row.id}>
                    ...
                    <TableCell style={{ width: 50 }} align="right">
                      <IconButton
                        onClick={() => onEditDivision && onEditDivision(row)}
                        size="small"
                      >
                        <EditOutlined />
                      </IconButton>
