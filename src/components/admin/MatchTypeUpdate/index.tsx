...
const MatchTypeUpdate: React.FC<PickerProps> = (props) => {
  ...
  return (
    ...
    >
      <form id="matchType-update" onSubmit={handleSubmit(onSubmit)}>
        <ButtonGroup
          fullWidth
          size="large"
          color="primary"
...
export default MatchTypeUpdate
